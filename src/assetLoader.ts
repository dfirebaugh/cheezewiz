...
export function LoadAssets(scene: Phaser.Scene) {
    ...
    scene.load.spritesheet('wiz-damaged', 'assets/cheezewiz-damaged.png', { frameHeight: 32, frameWidth: 32 })
    scene.load.spritesheet('wiz-death', 'assets/cheezewiz-death.png', { frameHeight: 32, frameWidth: 32 })
